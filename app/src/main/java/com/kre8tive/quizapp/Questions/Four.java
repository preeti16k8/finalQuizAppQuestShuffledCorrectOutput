...
public class Four extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // questions = QuizApp.getDaoSession().getQuestionsDao().loadAll();
        questionsfour=questions;

        //Answers
        answers.add(questionsfour.get(3).getCorrect());
        answers.add(questionsfour.get(3).getWrong1());
        answers.add(questionsfour.get(3).getWrong2());
        answers.add(questionsfour.get(3).getWrong3());
        ...
        question.setText(questionsfour.get(3).getQuestion());
        question1=questionsfour.get(3).getCorrect();
        ...
        btn1.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Result result1 = new Result(btn1.getText().toString(), questionsfour.get(3).getId());
        ...
        btn2.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Result result1 = new Result(btn2.getText().toString(), questionsfour.get(3).getId());
                QuizApp.getDaoSession().getResultDao().insert(result1);
        ...
        btn3.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Result result1 = new Result(btn3.getText().toString(), questionsfour.get(3).getId());
                QuizApp.getDaoSession().getResultDao().insert(result1);
        ...
        btn4.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Result result1 = new Result(btn4.getText().toString(), questionsfour.get(3).getId());
                QuizApp.getDaoSession().getResultDao().insert(result1);
    ...
    private void checkAnswer(String btntxt) {
        ...
        if(btntxt.equals(question1)){
            Intent intent = new Intent(Four.this, CorrectActivity.class);
            intent.putExtras(bundle);
            startActivity(intent);
            finish();

        }else {
            Intent intent = new Intent(Four.this, WrongActivity.class);
            intent.putExtras(bundle);
            startActivity(intent);
            finish();
        }
